...
export class PuzzleWalletAdapter extends BaseMessageSignerWalletAdapter {
    ...
    constructor({ }: PuzzleWalletAdapterConfig = {}) {
        super();
    ...
    async connect(
        ...
        try {
            ...
            try {
                ...
                this._publicKey = account.account?.address as string;
                this.emit('connect', this._publicKey as string);
            } catch (error: any) {
    ...
    requestTransactionHistory(_program: string): Promise<any[]> {
        throw new Error('Method not implemented.');
    }
}
